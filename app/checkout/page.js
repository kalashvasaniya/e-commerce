      ...
      <div className="md:grid md:grid-cols-2 px-6">
        ...
        <div className="p-8 bg-gray-200 flex flex-col rounded-3xl" >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Link href={''}>
              {/* <Link href={'https://buy.stripe.com/test_00gaGB0dv6MsgOk289'}> */}
              <button onClick={(() => {
                checkout(
                  {
                    lineItems: [{ price: "price_1OlX5qSDMGPsOOORYllfUwlX", quantity: 1 }]
                  }
                )
              })} disabled={disabled} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
