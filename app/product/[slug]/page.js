                        ...
                        <div className="md:grid grid-cols-3 m-auto">
                            ...
                            <div className="col-span-2 lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex">
                                    ...
                                    <button onClick={() => addToCart(params.slug, 'Vintage Vortex', 58, 1, 'M', 'black')} className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-700 rounded">Add to Cart</button>
