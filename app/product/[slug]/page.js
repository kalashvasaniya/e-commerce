                            ...
                            <div class="col-span-2 lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                    ...
                                    <div class="flex ml-6 items-center">
                                        <span class="mr-3 text-gray-300">Size</span>
                                        <div class="relative">
                                ...
                                <div class="flex">
                                    ...
                                    <button class="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-700 rounded">Add to Cart</button>
                                    <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-900 ml-4">
                                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
