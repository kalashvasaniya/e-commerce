                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="md:order-4 inline-flex">
                        ...
                        <div className="md:block hidden">
                            <button className="text-gray-100 hover:ring-2 hover:ring-gray-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 ml-6" type="button" data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar">
