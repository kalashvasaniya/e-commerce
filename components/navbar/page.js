                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="md:order-4 inline-flex">
                        ...
                        <div onClick={toggleCart} className="md:block hidden">
                            ...
                            <div ref={ref} onClick={toggleCart} className="absolute top-0 left-0 z-60 w-96 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-gray-800" tabIndex="-1">
                                <h5 className="text-base font-semibold uppercase text-gray-200">shopping cart</h5>
                                <button onClick={toggleCart} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center" >
                                ...
                                <div className="py-4 overflow-y-auto">
                                    <ul className="space-y-2 font-medium">
                                        ...
                                        {Object.keys(cart).length === 0 &&
                                            <div className="flex justify-center p-2 text-gray-200 rounded-lg">
                                        ...
                                        {Object.keys(cart).map((key) => {
                                            return (
                                                <li key={key} className='grid grid-cols-2'>
                                                    {cart[key].quantity > 0 && (
                                                        <div className="flex items-center p-2 text-gray-200 rounded-lg">
                                                            <span className="underline-offset-4 underline font-mono truncate">
                                                                {cart[key].name}
                                                            </span>
                                                        </div>
                                                    )}
                                ...
                                <div className="flex space-x-4 mt-16 justify-center">
                                    <button onClick={clearCart} className="right-2.5 bottom-2.5 text-white bg-pink-500 hover:bg-pink-700 font-medium rounded-lg text-sm px-4 py-2">Clear Cart</button>
                                    <Link href={'/checkout'}>
                                        <button className="right-2.5 bottom-2.5 text-white bg-pink-500 hover:bg-pink-700 font-medium rounded-lg text-sm px-4 py-2">Checkout</button>
                                    </Link>
                                </div>
            ...
            < nav className='md:hidden' >
                <div className="fixed z-50 w-full h-16 max-w-xs -translate-x-1/2 bg-gray-800 rounded-full bottom-4 left-1/2">
                    <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
                        ...
                        <Link href={'/user/login'} data-tooltip-target="tooltip-profile" type="button" className="inline-flex flex-col items-center justify-center px-5 rounded-r-full group">
                            <svg className="w-6 h-6 mb-1 text-gray-400 group-hover:text-pink-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div id="tooltip-profile" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            {
                                user.value ? <div>Logout</div> : <div>Login</div>
                            }
                            <div className="tooltip-arrow" data-popper-arrow></div>
                        </div>
