                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="md:order-4 inline-flex">
                        ...
                        <div className=" md:block hidden pl-6">
                            ...
                            <Image src={'/logo.jpeg'} width={100} height={100} id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" className="w-10 h-10 rounded-full cursor-pointer" alt="User dropdown" />
                        ...
                        <div className="md:block hidden">
                            <button className="text-gray-100 hover:ring-2 hover:ring-gray-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 ml-6" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
